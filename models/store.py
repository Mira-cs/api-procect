...
class StoreSchema(ma.Schema):
  ...
  phone_number = fields.Integer(required=True, validate=And(Length(min=6), Regexp('^[0-9 ]+$', error='Only numbers and spaces are allowed')))
  street_number = fields.Integer(required=True, validate=Length(min=1))
  ...
  zip_code = fields.Integer(required=True, validate=Length(min=4))
  class Meta:
